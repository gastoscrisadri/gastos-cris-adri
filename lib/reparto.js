 ...
 * - Lo que está a cargo de alguien (a_cargo_de) cuenta entero para esa persona
 *   y cero para la otra, aunque lo haya pagado ella.
...
export function construirReparto(categorias) {
  ...
  return function miParte(t, yo) {
    ...
    // Gasto de uno pagado por el otro: entero de su dueño, cero del que puso
    // el dinero. Lo ven los dos, pero de uno solo es.
    if (t.a_cargo_de) return t.a_cargo_de === yo ? importe : 0
